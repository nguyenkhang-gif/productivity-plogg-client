...
export default function GenerateEpubModal() {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px] bg-surface text-text-primary">
        <DialogHeader>
          <DialogTitle className="text-text-primary">Add New Book</DialogTitle>
        </DialogHeader>
        <form className="grid gap-4 py-4" onSubmit={handleSubmit}>
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="author-name" className="text-right text-text-secondary">
              Author Name
            </Label>
            <Input
              id="author-name"
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="book-title" className="text-right text-text-secondary">
              Book Title
            </Label>
            <Input
              id="book-title"
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label className="text-right text-text-secondary">Chapters</Label>
              ...
              >
                {chapters.map((chapter, index) => (
                  <li key={index} className="flex justify-between items-center">
                    ...
                    <Card className="p-2 flex bg-surface-raised text-text-primary border-border">
                      {chapter.info.title}
                      <Button
                        variant="ghost"
                        size="icon"
