...
export default function FocusCoffePage() {
  ...
  const { navHidden, toggleNav } = useNavVisibility();

  return (
    <div className="relative min-h-[calc(100vh-3.5rem)] bg-page flex items-center justify-center px-4 py-6 md:py-10">
      ...
      <Card className="w-full max-w-md landscape:max-w-3xl bg-card border-border text-text-primary shadow-xl">
        <CardContent className="flex flex-col landscape:flex-row items-center justify-center gap-4 md:gap-6 landscape:gap-10 p-5 md:p-8">
